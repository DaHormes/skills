...
// Sample data
const data = [
  { name: 'John Doe', title: 'Software Engineer', skills: 'JavaScript, Python, React', category: 'Web Development', workDone: 'Built a full-stack web application', contact: 'johndoe@example.com' },
